...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <table id="category-table" class="table table-sm table-hover border">
                <thead>
                    <tr>
                        <th>
                ...
                <tr id="delete_{{$category->id}}">
                        ...
                        <td>
                            <a href="javascript:void(0);" class="text-info editform" data-bs-toggle="modal" data-bs-target="#edit-modal" data-id="{{$category->id}}" data-name="{{$category->name}}" data-status="{{$category->status_id}}"><i class="fas fa-pen"></i></a>
