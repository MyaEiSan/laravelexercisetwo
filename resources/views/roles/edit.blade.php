                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <lable for="image" class="gallery">Choose Images</lable>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                       <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="file" name="image" id="image"  class="form-control form-control-sm rounded-0" placeholder="Enter Role Name" value="{{$role->image}}" /> 
                        </div>
                        <div class="col-md-6 form-group mb-3">
                        ...
                        <div class="col-md-6 form-group">
                           ...
                           <select name="status_id" id="status_id" class="form-control form-control-sm rounded-0">
                                @foreach ($statuses as $status)
                                    <option value="{{$status->id}}" @if($status->id == $role->status_id) selected @endif >{{$status->name}}</option>
                                @endforeach
                           </select>
                        </div>
