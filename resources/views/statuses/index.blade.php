        ...
        <div class="col-md-12">
            ...
            <table class="table table-sm table-hover border">
                ...
                <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" class="text-info editform" data-bs-toggle="modal" data-bs-target="#edit-modal" data-id="{{$status->id}}" data-name="{{$status->name}}"><i class="fas fa-pen"></i></a>
