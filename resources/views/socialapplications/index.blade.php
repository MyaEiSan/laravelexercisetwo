        ...
        <div class="col-md-12">
            <table id="mytable" class="table table-sm table-hover border">
                ...
                <tr id="delete_{{$socialapplication->id}}">
                        ...
                        <td>
                            <a href="javascript:void(0);" class="text-info editform edit-btns" data-id="{{$socialapplication->id}}"><i class="fas fa-pen"></i></a>
...
<script>
    ...
    $(document).ready(function(){
        ...
        function fetchalldatas(){
            $.ajax({
                url: "{{route('socialapplications.fetchalldata')}}", 
                method:"GET", 
                type:"JSON", 
